...
#         with open(r"C:\Users\HP\Desktop\python\turtl\gamble\balance.txt", "r+") as save:
#             previous_data = save.read().strip()
#         with open(r"C:\Users\HP\Desktop\python\turtl\gamble\balance.txt", "r+") as file:
#             previous_data = int(previous_data) if previous_data.strip() else 0
#             file.write(str(previous_data + int(50)))
#         with open(r"C:\Users\HP\Desktop\python\turtl\gamble\balance.txt", "r+") as save:
#             previous_data = save.read().strip()
#             print("Balance is :- $", previous_data)
#     else:
